    ...
    <>
      ...
      <div className="writeprompt-container">
        < div className="prompt-box">
          ...
          <Card className="example-card" onClick={() => handleCardClick('What are the career options for with a degree in graphic design?')}>
              <CardContent>
                <Typography variant="h6"></Typography>
                <Typography variant="body2">"What are the career options with a degree in graphic design?"</Typography>
              </CardContent>
            </Card>
            <Card className="example-card" onClick={() => handleCardClick('How can I move from a marketing role to a brand management career?')}>
              <CardContent>
                <Typography variant="h6"></Typography>
                <Typography variant="body2">"How can I move from a marketing role to a brand management career?"</Typography>
              </CardContent>
            </Card>
            <Card className="example-card" onClick={() => handleCardClick('How can I start writing or creating content about sports while in high school?')}>
              <CardContent>
                <Typography variant="h6"></Typography>
                <Typography variant="body2">"How can I start writing or creating content about sports while in high school?"</Typography>
              </CardContent>
            </Card>
          </div>
      ...
      <div className="modal-text">
        {isLoading ? (
          <>
            ...
            <p>"Just a moment! We're getting your career info ready..."</p>
          </>
        ) : (
          <>
            ...
            <p>"Yay! Your career info is ready! Dive in and explore the awesome suggestions we've prepared for you!"</p>
          </>
        )}
      </div>
      {showOkButton && (
